<%-- Document   : index
    Created on : June 11, 2017, 19:08:08 PM
    Author     : Nadia
--%>
...
<%
    ...
    Document doc = db.parse("C:\Users\user\Documents\NetBeansProjects\JavaHomeworksCranganuNadia\src\xmlhomework\currency.xml");
